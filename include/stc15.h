...
#define TIMER1_INT	    3
#define TIMER2_INT	    5
#define gsm_SERIAL_INT	4
#define MP3_SERIAL_INT  8
...
#define P40OUTPUT	P4M1 &= !BIT0;P4M0 |= BIT0
#define P41OUTPUT	P4M1 &= !BIT1;P4M0 |= BIT1
#define P42OUTPUT	P4M1 &= !BIT2;P4M0 |= BIT2
#define P43OUTPUT	P4M1 &= !BIT3;P4M0 |= BIT3
#define P44OUTPUT	P4M1 &= !BIT4;P4M0 |= BIT4
#define P45OUTPUT	P4M1 &= !BIT5;P4M0 |= BIT5
#define P46OUTPUT	P4M1 &= !BIT6;P4M0 |= BIT6
#define P47OUTPUT	P4M1 &= !BIT7;P4M0 |= BIT7

#define P40INPUT	P4M0 &= !BIT0;P4M1 |= BIT0
#define P41INPUT	P4M0 &= !BIT1;P4M1 |= BIT1
#define P42INPUT	P4M0 &= !BIT2;P4M1 |= BIT2
#define P43INPUT	P4M0 &= !BIT3;P4M1 |= BIT3
#define P44INPUT	P4M0 &= !BIT4;P4M1 |= BIT4
#define P45INPUT	P4M0 &= !BIT5;P4M1 |= BIT5
#define P46INPUT	P4M0 &= !BIT6;P4M1 |= BIT6
#define P47INPUT	P4M0 &= !BIT7;P4M1 |= BIT7
